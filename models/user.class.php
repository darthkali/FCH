...
class User extends BaseModel
{
    ...
    public static function changeUserRoleAndFunction($userID, $newRole, $newfunctionFCH = null){
    ...
    public static function generateUserProfilInformations(){
        ...
        if ($actualMemberHistory != ''){
            $userFunction = $actualMemberHistory['FUNCTION_FCH_ID'];
        }else{
            $userFunction = 0;
        }

        $allRoles = Role::find();
        $allFunctions = Function_FCH::find();
    ...
    public static function generateSortClauseForMember($sortMemberGET){
        switch ($sortMemberGET) {
            ...
            case 11:
                return $sortMember = 'ORDER BY FUNCTION_FCH_ID';
            case 12:
                return $sortMember = 'ORDER BY FUNCTION_FCH_ID DESC';
            default:
                return $sortMember = '';
        }
    }
    ...
    public static function generateSortClauseForUser($sortUserGET){
        switch ($sortUserGET) {
            ...
            case 11:
                return  $sortUser = 'ORDER BY FUNCTION_FCH_ID';
            case 12:
                return  $sortUser = 'ORDER BY FUNCTION_FCH_ID DESC';
            default:
                return  $sortUser = '';
        }
    }
    ...
    public static function generateSortClauseForUserPage($sortUserPOST){
        switch ($sortUserPOST){
            case 1:
                return $filterSort = 'ORDER BY FUNCTION_FCH_ID';
            case 2:
    ...
    public static function validateUser($newUser, &$eingabeError){
        ...
        }elseif (!preg_match('/^[A-Za-zßäöü][A-Za-z ßäöü]*$/', $newUser->__get('FIRSTNAME'))) {
        ...
        } elseif (!preg_match('/^[A-Za-zßäöü][A-Za-z ßäöü]*$/', $newUser->__get('LASTNAME'))) {
