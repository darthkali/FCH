<?php
use FCH\function_FCH;
use FCH\MemberHistory;
use FCH\User;
?>
...
<div class="Content" id="fadeIn">
    ...
    <h1>Unsere Mitglieder</h1>
        ...
        <form method="post" class="filterBox">
            ...
            <div class="sortFilterBox">
                <label for="functionFSRUser">Funktion im Verein:</label><br>
                    <select name="functionFCHUser" id="functionFCHUser">
        ...
        <? foreach($userList as $user) : ?>
            <div class="userBox">
                <img data-img class="center" src=<?=USER_PICTURE_PATH.$user['PICTURE']?> alt = "Bilder der mitglieder des FC Hannover">
                <p><h2><?=User::getFullName($user['FIRSTNAME'], $user['LASTNAME']);?></h2>
                <strong><?=function_FCH::generateFunctionFCHNameByUserID($user['MEMBER_ID'])?></strong>
                    ...
                    <? foreach ($userMember as $member):?>
                        <?  $startDate = date("d.m.y",strtotime($member['START_DATE']));
                            ...
                            $functionFSR = function_FCH::generateFunctionFCHNameByFunctionID($member['FUNCTION_FCH_ID']);
                        ?>
